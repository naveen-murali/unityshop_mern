...
export const ORDER_DETAILS_CANCEL_REQUEST = 'ORDER_DETAILS_CANCEL_REQUEST';
export const ORDER_DETAILS_CANCEL_SUCCESS = 'ORDER_DETAILS_CANCEL_SUCCESS';
export const ORDER_DETAILS_CANCEL_FAIL = 'ORDER_DETAILS_CANCEL_FAIL';
