...
const ConfirmAlert = ({ show, confirmAction, cancelAction, message }) => {
        ...
        <div className={state ? 'confirmAlert show' : 'confirmAlert'}>
            <Card
                className={showCard
                    ...
                    : 'border-0 rounded-2 shadow confrimAlert-card p-2'}
                ...
                <Card.Body>
                    ...
                    <Card.Text className='py-3 text-dark letter-spacing-1' as='h5'>
                        {message}
                    </Card.Text>
